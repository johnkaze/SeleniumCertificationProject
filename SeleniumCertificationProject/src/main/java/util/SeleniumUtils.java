...
public class SeleniumUtils {
    ...
    public boolean waitForElementClickable(WebDriver driver, Identifier identifier, String locator) {
        try {
            Wait<WebDriver> wait = new FluentWait<>(driver).withTimeout(Duration.ofSeconds(explicitWait)).
                    ignoring(NoSuchElementException.class).ignoring(WebDriverException.class);
    ...
    public boolean waitForElementClickable(WebDriver driver, WebElement webElement, int duration) {
		try {
